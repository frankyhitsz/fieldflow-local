...
- The current work-order state model is intentionally small: pending, started, completed. Dispatch acceptance, en-route, arrival, cancellation, parts, crews, breaks, and multi-day work are not modelled.
