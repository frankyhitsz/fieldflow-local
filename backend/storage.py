...
BUILTIN_PROFILES: tuple[StrategyProfile, ...] = (
    ...
    StrategyProfile(id="completion", name="完成率优先", description="优先多排工单，必要时增加行程和加班", builtin=True, weights=StrategyWeights(travel_weight=1, sla_late_weight=1, overtime_weight=1, imbalance_weight=1, replan_change_weight=60, unassigned_penalty_scale=5), time_limit_seconds=2, created_at="2026-08-23T00:00:00+00:00"),
